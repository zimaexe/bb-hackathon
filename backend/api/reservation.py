...
async def create_reservation(
    ...
    """
    logger.info(f"Creating reservation for place {reservation_in.place_id} at fair {reservation_in.fair_id}")
    reservation = await reservation_crud.create_reservation(db=db, reservation_in=reservation_in)
